...
Otherwise flash **both** modules. Use **desktop Chrome or Edge** (they support Web Serial).

### Easiest — one-click web flasher

Open the hosted flasher and click install — no download, no file picking, no offsets:

**➡️ https://aquahika.github.io/soccer-communication-module/web/flasher-link/**

1. Plug the module into the computer with a USB-C cable, and open the link above.
2. Click **Install firmware**, then pick the module's serial port in the browser popup.
3. Wait for it to finish. Repeat for the second module.

It flashes the merged image at `0x0` and fully erases first.
